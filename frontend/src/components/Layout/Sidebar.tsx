      ...
      >
        ...
        <div className="flex items-center justify-between h-16 px-4 border-b border-gray-200">
          <Link to="/dashboard" className="flex items-center gap-3">
            <div className="w-10 h-10 bg-gradient-to-br from-federal-500 to-hubzone-600 rounded-xl flex items-center justify-center shadow-lg">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">HUBZone Program</p>
            </div>
          </Link>
                    ...
                    <NavLink
                      ...
                      className={({ isActive }) =>
                        clsx(
                          ...
                          isActive
                            ? 'bg-hubzone-50 text-hubzone-700 border-l-2 border-hubzone-600'
        ...
        <div className="p-4 border-t border-gray-200">
          <div className="bg-gradient-to-br from-hubzone-50 to-federal-50 rounded-xl p-4">
            ...
            <a
              href="#support"
              className="block w-full px-3 py-2 text-center text-sm font-medium text-hubzone-700 bg-white border border-hubzone-200 rounded-lg hover:bg-hubzone-50 transition-colors"
            >
              Contact Support
            </a>
          </div>
